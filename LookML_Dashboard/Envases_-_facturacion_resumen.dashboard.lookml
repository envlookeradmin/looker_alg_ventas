---
- dashboard: envases__facturacion_resumen
  title: Envases - facturacion_resumen
  layout: newspaper
  preferred_viewer: dashboards-next
  description: ''
  preferred_slug: tuHzAHsp1YVLqo7B14Nu9h
  elements:
  ...
  - title: Category
    ...
    explore: ventas
    type: looker_grid
    fields: [ventas.orden_categoria, planta.cluster, planta.pais, ventas.categoria,
      ventas.subcategoria, ventas.daily_sales, ventas.total_qty_mtd, ventas.total_amount_mtd,
      ventas.total_amount_mtd_ly, ventas.total_amount_bud_mtd, ventas.total_qty_ytd,
      ventas.total_amount_ytd, ventas.total_amount_ytd_ly, ventas.total_amount_bud_ytd]
    filters:
      ventas.bandera_total: '0'
  ...
  - title: Currency
    ...
    explore: ventas
    type: looker_grid
    fields: [ventas.FCURR, ventas.m_tc_diario]
    filters:
  ...
  - name: Planta
    ...
    model: alg_facturacion
    explore: ventas
    listens_to_filters: [Pais, Cluster]
    field: planta.nombre_planta
  - name: Category
    title: Category
    type: field_filter
    default_value: ''
    ...
    model: alg_facturacion
    explore: ventas
    listens_to_filters: [Planta]
    field: ventas.categoria
