---
- dashboard: alg074_monitor_budget
  title: "(ALG-074) Monitor Budget"
  layout: newspaper
  preferred_viewer: dashboards-next
  description: ''
  preferred_slug: j2xumKTcH8f52rpWZQWwon
  elements:
  - title: MONITOR PRESUPUESTOS
    name: MONITOR PRESUPUESTOS
    model: alg_facturacion
    explore: ventas_consolidado
    type: looker_grid
    fields: [ventas_consolidado.id_fuente, ventas_consolidado.monto_dia_mtd, ventas_consolidado.dias_habiles_mtd,
      ventas_consolidado.monto_dia_ytd, ventas_consolidado.dias_habiles_ytd, ventas_consolidado.pais,
      ventas_consolidado.moneda_transaccion, ventas_consolidado.amount_bud_mtd_converted,
      ventas_consolidado.amount_bud_mtd, ventas_consolidado.amount_bud_ytd_converted,
      ventas_consolidado.amount_bud_ytd]
    filters:
      ventas_consolidado.tipo_transaccion: Presupuesto
    sorts: [ventas_consolidado.id_fuente desc]
    limit: 500
    column_limit: 50
    total: true
    ...
    column_order: [ventas_consolidado.id_fuente, ventas_consolidado.pais, ventas_consolidado.moneda_transaccion,
      ventas_consolidado.amount_bud_mtd_converted, ventas_consolidado.amount_bud_mtd,
      ventas_consolidado.monto_dia_mtd, ventas_consolidado.dias_habiles_mtd, ventas_consolidado.amount_bud_ytd_converted,
      ventas_consolidado.amount_bud_ytd, ventas_consolidado.monto_dia_ytd, ventas_consolidado.dias_habiles_ytd]
    show_totals: true
    ...
    series_labels:
      ...
      ventas_consolidado.moneda_transaccion: Transaction currency
  ...
  - title: POR LINEA DE NEGOCIO
    name: POR LINEA DE NEGOCIO
    model: alg_facturacion
    explore: ventas_consolidado
    type: looker_grid
    fields: [ventas_consolidado.pais, ventas_consolidado.categoria, ventas_consolidado.total_qty_bud_ytd,
      ventas_consolidado.total_qty_bud_mtd, ventas_consolidado.amount_bud_ytd, ventas_consolidado.amount_bud_mtd,
      ventas_consolidado.amount_bud_mtd_converted, ventas_consolidado.amount_bud_ytd_converted]
    filters:
      ventas_consolidado.tipo_transaccion: Presupuesto
    sorts: [ventas_consolidado.pais]
    limit: 500
    column_limit: 50
    total: true
    show_view_names: false
    ...
    conditional_formatting_include_nulls: false
    show_sql_query_menu_options: false
    column_order: [ventas_consolidado.pais, ventas_consolidado.categoria, ventas_consolidado.amount_bud_mtd_converted,
      ventas_consolidado.amount_bud_mtd, ventas_consolidado.total_qty_bud_mtd, ventas_consolidado.amount_bud_ytd_converted,
      ventas_consolidado.amount_bud_ytd, ventas_consolidado.total_qty_bud_ytd]
    show_totals: true
    show_row_totals: true
    truncate_header: false
    minimum_column_width: 10
    series_labels:
      ...
      ventas_consolidado.pais: Country
      ventas_consolidado.categoria: Category
    series_cell_visualizations:
      ventas_consolidado.daily_sales:
        is_active: false
    header_font_color: "#FFFFFF"
  ...
  - title: POR PLANTA
    ...
    explore: ventas_consolidado
    type: looker_grid
    fields: [ventas_consolidado.pais, ventas_consolidado.id_planta, ventas_consolidado.nombre_planta,
      ventas_consolidado.total_qty_bud_ytd, ventas_consolidado.total_qty_bud_mtd,
      ventas_consolidado.amount_bud_mtd, ventas_consolidado.amount_bud_ytd, ventas_consolidado.amount_bud_ytd_converted,
      ventas_consolidado.amount_bud_mtd_converted]
    filters:
      ventas_consolidado.tipo_transaccion: Presupuesto
    sorts: [ventas_consolidado.pais]
    limit: 500
    ...
    conditional_formatting_include_nulls: false
    show_sql_query_menu_options: false
    column_order: [ventas_consolidado.pais, ventas_consolidado.id_planta, ventas_consolidado.nombre_planta,
      ventas_consolidado.amount_bud_mtd_converted, ventas_consolidado.amount_bud_mtd,
    ...
    series_labels:
      ...
      ventas_consolidado.total_qty_bud_mtd: Qty bud MTD
      ventas_consolidado.pais: Country
      ventas_consolidado.id_planta: Plant
      ventas_consolidado.nombre_planta: Plant name
    series_cell_visualizations:
      ventas_consolidado.daily_sales:
        is_active: false
    header_font_color: "#FFFFFF"
